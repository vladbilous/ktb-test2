...
<div class="index">
    ...
    <div class="main-page">
        ...
        <section class="slider row1">
            ...
            <div><img src="<?php echo get_template_directory_uri() ?>/images/Butik.jpg" alt=""/>
                <div class="slider__text-block">
                    <div class="slider__text-block-all">
                        <div class="block-text-in-slide">
                            <p class="title-slide">
            ...
            <div><img src="<?php echo get_template_directory_uri() ?>/images/Mikolaiv-min.jpg" alt=""/>
                <div class="slider__text-block">
                    <div class="slider__text-block-all">
            ...
            <div><img src="<?php echo get_template_directory_uri() ?>/images/Sumi-min.jpg" alt=""/>
                <div class="slider__text-block">
                    <div class="slider__text-block-all">
                        <div class="block-text-in-slide">
                            <p class="title-slide">
