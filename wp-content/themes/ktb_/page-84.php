<div class="test-audio-video">
<!--    <audio autoplay="autoplay" controls>-->
<!--        <source src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp4" type="audio/mp4">-->
<!--        Тег audio не поддерживается вашим браузером.-->
<!--        <a href="audio/music.mp3">Скачайте музыку</a>.-->
<!--    </audio>-->
    <audio src="<?php echo get_template_directory_uri() ?>/video/Map_video_005.mp4" autoplay="autoplay"></audio>
