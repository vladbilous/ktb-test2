                        ...
                        <table>
                            <tr>
                                <td class="contacts__info-img">
                                    <img class="img-icons ic1" src="<?php echo get_template_directory_uri() ?>/images/kontakts-icon1.png" alt=""/>
                                </td>
...
<!--  м. Київ, вул. Бориспільська, 9С-->
                            ...
                            <tr>
                                <td class="contacts__info-img">
                                    <img class="img-icons ic2" src="<?php echo get_template_directory_uri() ?>/images/kontakts-icon2.png" alt=""/>
                                </td>
                                <td class="contacts__info-text">
                            ...
                            <tr>
                                <td class="contacts__info-img">
                                    <img class="img-icons ic3" src="<?php echo get_template_directory_uri() ?>/images/kontakts-icon3.png" alt=""/>
                                </td>
                                <td class="contacts__info-text">
                            ...
                            <tr>
                                <td class="contacts__info-img">
                                    <img class="img-icons ic4" src="<?php echo get_template_directory_uri() ?>/images/kontakts-icon4.png" alt=""/>
                                </td>
                                <td class="contacts__info-text">
