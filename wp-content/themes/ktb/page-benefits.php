        ...
        <div class="ktb row-benefits">
            <div class="one-benefit ob1">
                <div class="one-benefit__img-title">
                    <img class="img-ben-pc img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon1.png" alt=""/>
                    <img class="img-ben-mob img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon1-mobile.png" alt=""/>
...
<!--            Від котеджів з індивідуальним проектуванням до великих промислових об'єктів.-->
            ...
            <div class="one-benefit ob2">
                <div class="one-benefit__img-title">
                    <img class="img-ben-pc img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon2.png" alt=""/>
                    <img class="img-ben-mob img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon2-mobile.png" alt=""/>
                    <p class="row-benefits__title">
<!--                ВІДКРИТІСТЬ-->
...
<!--            Все це значно зменшує терміни виконання і дозволяє швидше ввести об'єкт в експлуатацію.-->
            ...
            <div class="one-benefit ob3">
                <div class="one-benefit__img-title">
                    <img class="img-ben-pc img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon3.png" alt=""/>
                    <img class="img-ben-mob img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon3-mobile.png" alt=""/>
                    <p class="row-benefits__title">
<!--                ШВИДКІСТЬ-->
            ...
            <div class="one-benefit ob4">
                <div class="one-benefit__img-title">
                    <img class="img-ben-pc img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon4.png" alt=""/>
                    <img class="img-ben-mob img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon4-mobile.png" alt=""/>
                    <p class="row-benefits__title">
...
<!--            Поєднання якісних матеріалів та новітніх технологій в рази покращує та пришвидшує будівництво об’єктів.-->
            ...
            <div class="one-benefit ob5">
                <div class="one-benefit__img-title">
                    <img class="img-ben-pc img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon5.png" alt=""/>
                    <img class="img-ben-mob img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon5-mobile.png" alt=""/>
                    <p class="row-benefits__title">
...
<!--            а зробити більше, перевершити себе та попередні об’єкти. Кожен наступний наш об’єкт стає тільки краще.-->
            ...
            <div class="one-benefit ob6">
                <div class="one-benefit__img-title">
                    <img class="img-ben-pc img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon6.png" alt=""/>
                    <img class="img-ben-mob img-benefist" src="<?php echo get_template_directory_uri() ?>/images/benefits-icon6-mobile.png" alt=""/>
                    <p class="row-benefits__title">
<!--                ВІДПОВІДАЛЬНІСТЬ-->
