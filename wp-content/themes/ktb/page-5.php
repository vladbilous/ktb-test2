...
<div id="" class="video-main ">
    <p class="close-video">skip</p>
    <p class="close-video-mobile">skip</p>
    <a id="songsOn" class="songs-on">  <img src="<?php echo get_template_directory_uri() ?>/images/soung_icon_off.png" alt=""/></a>
    <a id="songsOff" class="songs-off">  <img src="<?php echo get_template_directory_uri() ?>/images/soung_icon_on.png" alt=""/></a>
    <a id="songsOnMobile" class="songs-on-mobile">  <img src="<?php echo get_template_directory_uri() ?>/images/soung_icon_off.png" alt=""/></a>
    <a id="songsOffMobile" class="songs-off-mobile">  <img src="<?php echo get_template_directory_uri() ?>/images/soung_icon_on.png" alt=""/></a>


    <!--    norm-->
<!--        <video src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp4"  muted autoplay="" playsinline="" loop="" o></video>-->
<!--        <video src="--><?php //echo get_template_directory_uri() ?><!--/video/mobile-video.mp4"  muted autoplay="" playsinline="" loop="" o></video>-->


    <video id="myVideo2" class="mob-video move" src="<?php echo get_template_directory_uri() ?>/video/mobile-video.mov" preload="auto" autoplay="true" muted="true">
    </video>

    <video id="myVideo" class="pc-video move" src="<?php echo get_template_directory_uri() ?>/video/Map_video_005.mp4" preload="auto" autoplay="true" muted="true">
    </video>

<!--    <video id="myVideo" class="pc-video move" preload="auto" autoplay="true" muted="true">-->
<!--        <source src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp4"  type="video/mp4">-->
<!--    </video>-->


<!--            <video src="--><?php //echo get_template_directory_uri() ?><!--/video/mobile-video.mp4"  muted autoplay="" playsinline="" loop="" o></video>-->

<!--    <video id="myVideo2" class="mobile-video move" src="--><?php //echo get_template_directory_uri() ?><!--/video/mobile-video.mp4" muted autoplay="" playsinline="" loop=""></video>-->


    <!--    <video id="myVideo2" class="mobile-video move" preload="auto" autoplay="true" muted="true">-->
<!--        <source src="--><?php //echo get_template_directory_uri() ?><!--/video/mobile-video.mp4"  type="video/mp4">-->
<!--    </video>-->

<!--        <video id="video" src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp4" muted="true" loop="loop"></video>-->
...
<!--    --><?php
//    $args = array(
//        'src'      => "/wp-content/themes/ktb/video/Map_video_005.mp3",
//        'loop'     => true,
//        'autoplay' => true,
//        'muted' => true,
//        'preload'  => 'none'
...
<!--            <iframe id="video-player" class="video" width="560" height="315" src="https://player.vimeo.com/video/309741585?autoplay=1&muted=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay"></iframe>-->
<!--        </div>-->
<!--    </div>-->
...
<!--    </script>-->
    ...
    <!--    <bgsound src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp3" loop="-1" volume="0" balance="0">-->
<!--        <audio src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp3" autoplay="autoplay">-->

<!--    <embed src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp3" autostart="true" hidden="false" loop="false" width="300" height="65" align="bottom"> </embed>-->
...
<!---->
<!---->
<!--    <video autoplay id="videoPlayer" width="100%" height="auto" onTimeUpdate="progressUpdate()">-->
<!--        <source src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.mp4" type="video/mp4">-->
<!--        <source src="--><?php //echo get_template_directory_uri() ?><!--/video/Map_video_005.webm" type="video/webm">-->
<!--    </video>-->
<!--    <div>-->
    ...
    <div class="main-page">
        ...
        <section class="slider row1">
            ...
            <div class="block-slide">
                <img class="slide-pc" src="<?php echo get_template_directory_uri() ?>/images/slide.png" alt=""/>
                <img class="slide-mob" src="<?php echo get_template_directory_uri() ?>/images/slide-main-mobile.jpg" alt=""/>
            ...
            <div>
                <img class="slide-pc" src="<?php echo get_template_directory_uri() ?>/images/Butik.jpg" alt=""/>
                <img class="slide-mob" src="<?php echo get_template_directory_uri() ?>/images/Butik-mobile.jpg" alt=""/>
            ...
            <div>
                <img class="slide-pc" src="<?php echo get_template_directory_uri() ?>/images/Mikolaiv-min.jpg" alt=""/>
                <img class="slide-mob" src="<?php echo get_template_directory_uri() ?>/images/Mikolaiv-min-mobile.jpg" alt=""/>
            ...
            <div>
                <img class="slide-pc" src="<?php echo get_template_directory_uri() ?>/images/Sumi-min.jpg" alt=""/>
                <img class="slide-mob" src="<?php echo get_template_directory_uri() ?>/images/Sumi-min-mobile.jpg" alt=""/>
                <div class="slider__text-block">
                    <div class="slider__text-block-all">
                        <div class="block-text-in-slide">
                            <p class="title-slide">
...
<!--                років-->
        ...
        <section class="row5" id="row5">
            ...
            <div class="row5__block-icons row5__block-icons-mobile">
                <a href="/services/">

                <div class="ktb">

                    <div class="row5__td row5__td1">
                                <img src="<?php echo get_template_directory_uri() ?>/images/Icon_1-mobile.png" alt="">
                                <p>
                                    <!--                        ЗЕМЛЯНІ РОБОТИ-->
                                    <?php pll_e( "main-services1-title" ); ?>
                                </p>
                    ...
                    <div class="row5__td row5__td2">

                                <img src="<?php echo get_template_directory_uri() ?>/images/Icon_2-mobile.png" alt="">
                                <p>
                                    <!--                        МОНТАЖ І ОБЛАШТУВАННЯ-->
                                    <!--                        КОНСТРУКЦІЇ-->
                    ...
                    <div class="row5__td row5__td3">

                    <img src="<?php echo get_template_directory_uri() ?>/images/Icon_3-mobile.png" alt="">
                                <p>
                                    <!--                        ВНУТРІШНІ-->
                                    <!--                        ОЗДОБЛЮВАЛЬНІ-->
                                    <!--                        РОБОТИ-->
                    ...
                    <div class="row5__td row5__td4">

                    <img src="<?php echo get_template_directory_uri() ?>/images/Icon_4-mobile.png" alt="">
                                <p>
                                    <!--                        МОНТАЖ-->
                                    <!--                        ІНЖЕНЕРНИХ-->
                                    <!--                        СИСТЕМ-->
                    ...
                    <div class="row5__td row5__td5">

                    <img src="<?php echo get_template_directory_uri() ?>/images/Icon_5-mobile.png" alt="">
                                <p>
                                    <!--                        ПОКРІВЕЛЬНІ РОБОТИ-->
                                    <?php pll_e( "main-services5-title" ); ?>
                    ...
                    <div class="row5__td row5__td6">

                    <img src="<?php echo get_template_directory_uri() ?>/images/Icon_6-mobile.png" alt="">
                                <p>
                                    <!--                        ФАСАДНІ РОБОТИ-->
                                    <?php pll_e( "main-services6-title" ); ?>
                    ...
                    <div class="row5__td row5__td7">

                    <img src="<?php echo get_template_directory_uri() ?>/images/Icon_7-mobile.png" alt="">
                                <p>
                                    <!--                        ПРОЕКТНІ РОБОТИ-->
                                    <?php pll_e( "main-services7-title" ); ?>
                    ...
                    <div class="row5__td row5__td8">

                    <img src="<?php echo get_template_directory_uri() ?>/images/Icon_8-mobile.png" alt="">
                                <p>
                                    <!--                        ІНЖИНІРИНГ-->
                                    <?php pll_e( "main-services8-title" ); ?>
